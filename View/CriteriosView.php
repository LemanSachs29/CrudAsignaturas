...
<head>
    ...
    <style>
        ...
        .table thead {
            background-color: #d9534f;
            /* Color retro para el encabezado de la tabla */
            color: white;
        }
        ...
        .text-center {
            color: #6c757d;
            /* Color retro para el texto centrado */
        }
    </style>
</head>
                    ...
                    <?php if (!empty($criterios)): ?>
                        <?php foreach ($criterios as $criterio): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../Controllers/CriterioEvaluacionController.php?action=editar&id=<?= $criterio->getId_criterio() ?>&id_resultado_aprendizaje=<?= $_GET['id_resultado_aprendizaje'] ?>&nombre_ra=<?= urlencode($_GET['nombre_ra']) ?>&id_asignatura=<?= $_GET['id_asignatura'] ?>&nombre_asignatura=<?= urlencode($_GET['nombre_asignatura']) ?>"
