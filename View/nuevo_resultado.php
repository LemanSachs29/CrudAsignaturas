...
<head>
    ...
    <title>Agregar Resultado de Aprendizaje</title>
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Agregar Resultado de Aprendizaje - <span class="text-primary"><?= htmlspecialchars($_GET['nombre_asignatura']) ?></span></h2>

        <form action="../Controllers/ResultadoAprendizajeController.php?action=agregar&id_asignatura=<?= $_GET['id_asignatura'] ?>&nombre_asignatura=<?= urlencode($_GET['nombre_asignatura']) ?>" method="POST">
            
            <!-- 🔥 Input oculto para mantener el ID de la asignatura -->
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="codigo" name="codigo" min="1" required>
            </div>
